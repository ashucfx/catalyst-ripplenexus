...
const offerTiers = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      'LinkedIn Full-Brand Reconstruction (Banner, DP, Authority Signals)',
      'Narrative Cover Letter — the narrative key to the boardroom',
      'Sector Heat Map: GCC / PE / SaaS opportunities',
      'ATS Stress-Testing across Workday, Greenhouse, Lever',
