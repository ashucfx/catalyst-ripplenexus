...
const selectionPlans = [
  {
    ...
    deliverables: [
      ...
      'Three highest-leverage positioning moves',
    ],
  ...
  },
  {
    ...
    name: 'Career Booster',
    subtitle: 'RESUME · LINKEDIN · COVER LETTER',
    anchor: 'Cover letter included complimentary. Pricing by experience tier.',
    roi: '15% off',
    deliverables: [
      'Executive Resume Rewrite',
      'LinkedIn Full Profile Optimisation',
      'LinkedIn Banner and DP direction',
      'Cover Letter (complimentary)',
    ],
    transformation: 'Invisible → Positioned',
    href: '/blueprint',
    ctaBase: 'View Pricing',
    featured: true,
  },
  {
    tier: 'III',
    ...
    name: 'Premium Plus',
    subtitle: 'EVERYTHING + PORTFOLIO WEBSITE',
    anchor: 'Cover letter included complimentary. Pricing by experience tier.',
    roi: '20% off',
    deliverables: [
    ...
    transformation: 'Positioned → Authoritative',
    href: '/blueprint',
    ctaBase: 'View Pricing',
  },
]
